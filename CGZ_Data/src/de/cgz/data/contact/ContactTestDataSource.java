...
import de.cgz.data.types.AbstractDataSource;


public class ContactTestDataSource extends AbstractDataSource<Contact> {
	...
	public DataContainerImpl getData(DataFilter<Contact> filter) {
		// TODO Auto-generated method stub
		return null;
	}

	
	public static PersonContainer createTestData() {
		final String[] fnames = { "Peter", "Alice", "Joshua", "Mike", "Olivia", "Nina", "Alex", "Rita", "Dan", "Umberto", "Henrik", "Rene", "Lisa", "Marge" };
		final String[] lnames = { "Smith", "Gordon", "Simpson", "Brown", "Clavel", "Simons", "Verne", "Scott", "Allison", "Gates", "Rowling", "Barks", "Ross", "Schneider", "Tate" };
		final String cities[] = { "Amsterdam", "Berlin", "Helsinki", "Hong Kong", "London", "Luxemburg", "New York", "Oslo", "Paris", "Rome", "Stockholm", "Tokyo", "Turku" };
		...
		try {
			...
			for (int i = 0; i < 100; i++) {
				...
				p.setPhoneNumber("+358 02 555 " + r.nextInt(10) + r.nextInt(10) + r.nextInt(10) + r.nextInt(10));
